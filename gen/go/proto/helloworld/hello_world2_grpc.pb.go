...
const (
	Greeter2_SayHello2_FullMethodName = "/helloworld.Greeter2/SayHello2"
)
...
func (c *greeter2Client) SayHello2(ctx context.Context, in *HelloRequest2, opts ...grpc.CallOption) (*HelloReply2, error) {
	out := new(HelloReply2)
...
func (UnimplementedGreeter2Server) SayHello2(context.Context, *HelloRequest2) (*HelloReply2, error) {
...
func _Greeter2_SayHello2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Greeter2Server).SayHello2(ctx, req.(*HelloRequest2))
	}
...
var Greeter2_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/helloworld/hello_world2.proto",
}
